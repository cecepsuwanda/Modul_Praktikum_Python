...
\hline
Struktur kode & 25\% & Pemakaian fungsi/struktur kontrol wajar; tidak ada duplikasi berlebihan; pada tugas lanjut: jejak tes, \texttt{logging}, atau anotasi tipe bila diminta modul \\
\hline
Gaya dan dokumentasi & 15\% & Penamaan jelas; komentar pada bagian non-trivial; proyek akhir memuat \texttt{README} dan dependensi/kemasan sesuai petunjuk \\
\hline
...
\begin{enumerate}[leftmargin=*]
  ...
  \item Python Software Foundation. \textit{The Python Standard Library}. \url{https://docs.python.org/3/library/index.html}
  ...
  \item Python Software Foundation. \texttt{unittest} --- \textit{unit testing framework}. \url{https://docs.python.org/3/library/unittest.html}
  \item pytest Development Team. \textit{pytest documentation}. \url{https://docs.pytest.org/}
  \item Python Software Foundation. \texttt{typing} --- \textit{Support for type hints}. \url{https://docs.python.org/3/library/typing.html}
  \item Typing documentation (mypy docs --- referensi praktis sistem tipe). \url{https://typing.readthedocs.io/}
  \item Python Software Foundation. \texttt{asyncio} --- \textit{Asynchronous I/O}. \url{https://docs.python.org/3/library/asyncio.html}
  \item Python Software Foundation. \texttt{concurrent.futures}. \url{https://docs.python.org/3/library/concurrent.futures.html}
  \item Python Software Foundation. \texttt{threading} / \texttt{multiprocessing}. \url{https://docs.python.org/3/library/threading.html} dan \url{https://docs.python.org/3/library/multiprocessing.html}
  ...
  \item The NumPy community. \textit{NumPy documentation}. \url{https://numpy.org/doc/stable/}
  ...
  \item Python Software Foundation. \texttt{contextlib} --- \textit{Utilities for with-statement contexts}. \url{https://docs.python.org/3/library/contextlib.html}
  \item Pallets. \textit{Flask documentation}. \url{https://flask.palletsprojects.com/}
\end{enumerate}

\section*{C. Evaluasi Akhir dan Integrasi Kompetensi}

Untuk menilai pencapaian secara menyeluruh, dosen dapat menggabungkan: (1) portofolio tugas praktikum per modul; (2) ujian praktikum tengah dan akhir sesuai RPS \textbf{TIF-105}; (3) mini-proyek akhir yang memadukan struktur kontrol, fungsi, struktur data, akses berkas, OOP/tes, serta elemen \textbf{CPMK-8} (kemasan, \textit{logging}/kualitas operasional, konkurensi ringan) dan \textbf{CPMK-9} (\texttt{numpy}/\texttt{pandas}) sesuai Bab penutup. Rubrik komprehensif memetakan indikator ke Sub-CPMK pada \texttt{silabus\_praktikum\_python.tex}.
...
\hline
Tugas praktikum mingguan & 28\% & CPMK-1 s.d. CPMK-9 sesuai minggu (jejak 8--9 pada sesi 12--13 dan tugas lanjutan) \\
\hline
...
\hline
Ujian praktikum akhir / proyek & 25\% & CPMK-5--9; integrasi; Minggu 15--16 \\
\hline
