...
\section{Contoh tambahan: \texttt{pathlib.Path} untuk teks}

\noindent Modul \texttt{pathlib} menyediakan antarmuka berorientasi objek untuk lintasan berkas; sering dipadukan dengan \texttt{read\_text}/\texttt{write\_text} untuk teks Unicode. Lihat tutorial berkas (\href{https://docs.python.org/3/tutorial/inputoutput.html#reading-and-writing-files}{Reading and Writing Files}, lampiran \textbf{[8]}) dan entri \texttt{pathlib} pada indeks pustaka standar (lampiran \textbf{[20]}).

\begin{lstlisting}[caption=pathlib ringkas]
from pathlib import Path

p = Path("contoh_pathlib.txt")
p.write_text("halo pathlib\n", encoding="utf-8")
...
\noindent Selain menangkap pengecualian, Anda dapat \texttt{raise} untuk memberi sinyal kesalahan ke pemanggil. Pustaka standar mendefinisikan banyak tipe \texttt{Exception}; dokumentasi bab pengecualian (\href{https://docs.python.org/3/tutorial/errors.html}{Errors and Exceptions}) dan lampiran \textbf{[8]} memberi pola resmi.
