...
\noindent Tiga tanda kutip (\texttt{"""..."""}) membuat string literal yang dapat memanjang beberapa baris; huruf \texttt{r} tepat sebelum kutip membentuk \textit{raw string} sehingga garis miring terbalik tidak diartikan sebagai \textit{escape}. Pola ini umum untuk pola berkas Windows dan regex; lihat bagian string pada \textit{The Python Tutorial} (lampiran \textbf{[8]}, \textbf{[9]}) dan ringkasan sintaks \textbf{[16]}.
