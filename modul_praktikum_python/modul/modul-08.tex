...
\noindent Saat berkas di-\texttt{import}, seluruh modul dieksekusi sekali; namun blok \texttt{if \_\_name\_\_ == "\_\_main\_\_"} pada modul yang diimpor tidak dijalankan. Contoh impor selektif berikut mengikuti tutorial modul resmi (\href{https://docs.python.org/3/tutorial/modules.html}{Modules}, lampiran \textbf{[8]}).
...
\section{Contoh tambahan: daftar ekspor publik modul}

\noindent Daftar \texttt{\detokenize{__all__}} mendefinisikan nama yang diimpor saat bentuk impor bintang (\texttt{import *}). Meskipun pola tersebut jarang dipakai di produksi, memahami mekanisme ini membantu merancang modul yang rapi.\newline
Tutorial modul resmi: \path{https://docs.python.org/3/tutorial/modules.html} (lampiran \textbf{[8]}).

\begin{lstlisting}[caption=Ekspor publik dengan dunder all]
"""modul contoh_all."""

__all__ = ["publik_a", "publik_b"]
