...
\section{Contoh tambahan: properti dengan \texttt{@property}}

\noindent \textit{Property} memungkinkan metode akses diakses seperti atribut, menjaga enkapsulasi ringan. Pola ini dibahas pada tutorial kelas (\href{https://docs.python.org/3/tutorial/classes.html}{Classes}, lampiran \textbf{[8]}) dan sering dipakai bersama pewarisan.

\begin{lstlisting}[caption=Getter sederhana dengan property]
class Lingkaran:
