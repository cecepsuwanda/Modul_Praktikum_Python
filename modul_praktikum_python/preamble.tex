...
% Paragraf pembuka sebelum cuplikan ``Studi kasus'' (subsection Kode: ...).
\newcommand{\introstudikasuskode}{%
  \noindent Cuplikan program lengkap di bawah mengintegrasikan materi bab ini. Perhatikan struktur \texttt{main}, pemecahan fungsi, dan konvensi penamaan; cocokkan perilaku dengan contoh ringkas di bagian awal bab. Rujukan belajar terbuka: \textit{The Python Tutorial} \href{https://docs.python.org/3/tutorial/}{docs.python.org/3/tutorial} (lampiran \textbf{[8]}, \textbf{[9]}); peta topik pada berkas \texttt{sumber\_materi.md}.%
  \par\medskip
}
...
% Judul terpusat: listing kode dan tabel mengambang.
% Figure tetap mengikuti \captionsetup global (raggedright). Bila nanti ada \caption pada longtable, tambahkan \captionsetup[longtable]{...} di sini.
\AtBeginDocument{%
